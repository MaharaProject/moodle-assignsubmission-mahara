...
$string['yesunlockdate'] = 'Yes, unlock after date';
$string['unlockdate'] = 'Unlock date';
$string['unlockdate_help'] = 'Unlock locked submitted pages after this date';
$string['unlockmaharasubmissions'] = 'Unlock Mahara portfolio submission';
